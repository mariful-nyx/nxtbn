    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, unique=True)),
                ('taxable', models.BooleanField(verbose_name=False)),
                ('physical_product', models.BooleanField(verbose_name=False)),
                ('track_stock', models.BooleanField(verbose_name=False)),
                ('has_variant', models.BooleanField(verbose_name=False)),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
